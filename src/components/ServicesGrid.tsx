...
import { Activity, Heart, Users, Sparkles } from 'lucide-react'
import { useQuoteForm } from '@/context/QuoteFormContext'
import Link from 'next/link'

const services = [
  { icon: Activity, title: 'Chiropractic Adjustments', description: 'Precise spinal adjustments to restore proper alignment and nervous system function. Feel the difference after your first visit.', href: '/services/adjustments' },
  { icon: Heart, title: 'Back & Neck Pain Relief', description: 'Stop living with pain. We treat the root cause, not just symptoms. Lower back, upper back, sciatica, and neck pain relief.', href: '/services/back-pain' },
  { icon: Users, title: 'Sports & Auto Injuries', description: 'Get back in the game or back on the road. Expert treatment for athletic injuries and auto accident recovery.', href: '/services/sports-injuries' },
  { icon: Sparkles, title: 'Wellness Care', description: 'Feel your best every day. Preventive care, posture correction, and maintenance to keep you moving well.', href: '/services/wellness-care' },
]
    ...
    <section id="services" className={`${mobileFormExpanded ? 'mt-0 pt-[4.5rem]' : '-mt-14 pt-[4.5rem]'} ${desktopFormExpanded ? 'md:mt-0 md:pt-36' : 'md:mt-0 md:pt-12'} pb-20 bg-gradient-to-b from-transparent via-blue-50/30 to-slate-100/50 relative overflow-hidden`}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Expert chiropractic care for the Treasure Valley</p>
        </div>
